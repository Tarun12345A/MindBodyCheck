...
<div class="container">
    <h1>Mental Health Question Result</h1>
...
<%
    ...
    String dataAgreeM = String.valueOf(agreedata);
    
    String dataDisagreeM = String.valueOf(disagreedata);
    String dataResultM = String.valueOf(resultdata);
    try{
    PreparedStatement pst2 = conn.prepareStatement("update RESULT_MINDBODYCHECK set MENTAL_RESULT_AGREE=?,  MENTAL_RESULT_DISAGREE=?, MENTAL_RESULT_TOTAL=? where USER_UID=?");
    pst2.setString(1, dataAgreeM);
    
    pst2.setString(2, dataDisagreeM);
